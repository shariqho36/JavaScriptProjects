...
//Ger the ticket price from the selectMovie Dropdown
let ticketPrice = +selectMovie.value; 

//Call the update UI function - get data from localstorage and update the UI
updateUI();
...
// Eveent Listeners
// 1. Listen for click for container
container.addEventListener('click', e => {
    //Check if target has a class of and also is not occpied
