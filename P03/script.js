...
function updateIcons() {
    // Check if video paused or playing
    if ( video.paused ) {
        // If video is pause, show the play button
...
function updateProgress() { 
    ...
    // Use current time to calcutate seconds
...
// Function to update the video progress based on progrss bar change
